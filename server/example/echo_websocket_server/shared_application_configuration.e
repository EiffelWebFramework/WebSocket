...
--	app_configuration: separate APPLICATION_CONFIGURATION
...
--	cell_item (cl: like app_configuration_cell): separate APPLICATION_CONFIGURATION
--		do
--			Result := cl.item
--		end
...
--	app_configuration_cell: separate CELL [separate APPLICATION_CONFIGURATION]
--		once ("PROCESS")
